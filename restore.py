...
def restore_image(image_path, blur_sigma, noise_level, gamma):
    ...
    cv2.imwrite("restored_output.png", img)
    print("Restoration complete! Saved as 'restored_output.png'")

# Use your actual model outputs here
restore_image("boat.png", blur_sigma=1.0893, noise_level=16.2089, gamma=0.8429)